...
%\maketitle
    ...
    \begin{figure}[H]
        ...
        \caption{Arbre abstrait syntaxique}\label{fig:figure5}
    \end{figure}

    Et à l'aide de notre script python et de graphviz on obtient l'arbre abstrait syntaxique suivant :

    \begin{figure}[H]
        \centering
        \includegraphics[width=1\textwidth]{arbre_draw}
        \caption{Arbre abstrait syntaxique}\label{fig:figure6}
    \end{figure}
